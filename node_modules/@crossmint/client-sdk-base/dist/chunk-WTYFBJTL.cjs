"use strict";Object.defineProperty(exports, "__esModule", {value: true});var n="crossmint-hosted-checkout-v3-overlay";function s(){function o(t){let e=document.createElement("div");e.setAttribute("id",n),Object.assign(e.style,{width:"100vw",height:"100vh","background-color":"rgba(0, 0, 0, 0.5)",inset:0,position:"fixed","z-index":"99999999",opacity:"0",transition:"opacity 0.25s ease-in-out",display:"flex","flex-direction":"column","justify-content":"center","align-items":"center",padding:"20px"}),e.innerHTML=l,document.body.appendChild(e),setTimeout(()=>{e.style.opacity="1"},10);let c=setInterval(()=>{t.window.closed&&(clearInterval(c),i())},250);e.addEventListener("click",()=>{clearInterval(c),i()})}function i(){let t=document.getElementById(n);t&&(t.style.opacity="0",setTimeout(()=>{t.remove()},250))}return{create:o,remove:i}}var l=`
