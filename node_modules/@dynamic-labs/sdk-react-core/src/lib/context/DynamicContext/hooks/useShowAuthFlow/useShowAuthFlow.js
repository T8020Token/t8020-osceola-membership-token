...
import { hasAllRequiredWalletsConnected } from '../../../../utils/functions/hasAllRequiredWalletsConnected/hasAllRequiredWalletsConnected.js';
...
const useShowAuthFlow = ({ isRenderingEmbeddedAuthFlow, isMultiWalletEnabled, setShowDynamicUserProfile, }) => {
    ...
    const setShowAuthFlow = useCallback((value, options = {}) => {
        ...
        const areAllRequiredWalletsConnected = hasAllRequiredWalletsConnected();
