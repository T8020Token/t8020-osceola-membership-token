...
const DynamicBridgeWalletCardBody = ({ walletAddress, walletBalance, walletKey, onDisconnectClick }) => {
    ...
    const nameService = useFetchNameService.useFetchNameService({ address: walletAddress });
    const options = [
        {
            Icon: null,
            ...
            copykey: 'dyn_bridge.widget.copy.ens',
        ...
        },
        {
            ...
            copykey: 'dyn_bridge.widget.copy.address',
            hide: !walletAddress,
        ...
        },
        {
            ...
            copykey: 'dyn_bridge.widget.disconnect',
