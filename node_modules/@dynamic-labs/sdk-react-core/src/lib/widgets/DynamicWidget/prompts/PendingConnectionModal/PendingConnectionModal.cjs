...
const PendingConnectionContent = () => {
    var _a;
    const { selectedWalletConnector, user, selectedWalletWithAction } = useInternalDynamicContext.useInternalDynamicContext();
    let title;
    let description;
    if (selectedWalletWithAction &&
        walletConnectorCore.isSocialWalletConnector(selectedWalletWithAction.wallet.connector)) {
        const account = getReferencedAccount.getReferencedAccount(user, selectedWalletWithAction.wallet.id);
    ...
    return (jsxRuntime.jsx(DefaultPromptModal.DefaultPromptLayout, { dataTestId: 'pending-connection-modal', icon: jsxRuntime.jsx(AuthProviderIcon.AuthProviderIcon // eslint-disable-line
        , { wallet: selectedWalletWithAction === null || selectedWalletWithAction === void 0 ? void 0 : selectedWalletWithAction.wallet }), title: title, children: jsxRuntime.jsx(Typography.Typography, { variant: 'body_normal', color: 'secondary', weight: 'regular', "data-testid": 'content', children: description }) }));
};
const PendingConnectionModal = () => (jsxRuntime.jsx(PromptModal.PromptModal, { onClose: useCloseMultiWalletPrompt.useCloseMultiWalletPrompt(), children: jsxRuntime.jsx(PendingConnectionContent, {}) }));
