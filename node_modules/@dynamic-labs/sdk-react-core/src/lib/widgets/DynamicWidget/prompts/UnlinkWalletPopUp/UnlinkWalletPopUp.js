...
const UnlinkWalletPopUpContent = ({ onClickCancel, }) => {
    var _a;
    const { removeWallet, setSelectedWalletWithAction, selectedWalletWithAction, } = useInternalDynamicContext();
    ...
    return (jsxs("div", { className: 'unlink-wallet-popup__container', children: [jsx(Typography, { color: 'primary', className: 'unlink-wallet-popup__title', variant: 'body_normal', as: 'h6', children: authMode === 'connect-only'
                    ...
                    : t('dyn_unlink_wallet_pop_up.unlink_description') }), jsx(TypographyButton, { buttonPadding: 'small', onClick: onConfirmClick, disabled: loading, buttonClassName: 'unlink-wallet-popup__button unlink-wallet-popup__button--shadow', buttonVariant: 'primary', expanded: true, typographyProps: {
