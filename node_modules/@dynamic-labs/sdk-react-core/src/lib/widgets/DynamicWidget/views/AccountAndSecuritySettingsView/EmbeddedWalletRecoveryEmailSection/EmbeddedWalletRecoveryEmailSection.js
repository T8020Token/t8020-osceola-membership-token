...
const EmbeddedWalletRecoveryEmailSection = ({ isLoading = false, }) => {
    ...
    return (jsxs("div", { className: 'settings-view__body__section', children: [jsxs("div", { className: classNames('settings-view__body__section__title', 'settings-view__body__section__title__info-icon'), children: [jsx(Typography, { copykey: 'dyn_settings.identity_section.title', color: 'secondary', weight: 'medium', children: t('dyn_settings.identity_section.title') }), jsx(Icon, { size: 'small', children: jsx(SvgFooterInfoIcon, { className: 'settings-view__body__section__title__info-icon', "data-testid": 'email-info-icon-title' }) })] }), jsx(TypographyButton, { dataTestId: 'manage-email-recovery-button', onClick: addEmbeddedWalletRecoveryEmail, buttonClassName: classNames('settings-view__body__section__button', 'settings-view__body__section__button__badge'), startSlot: 
