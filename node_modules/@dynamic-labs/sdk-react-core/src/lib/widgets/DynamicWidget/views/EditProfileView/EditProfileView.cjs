...
const EditProfileView = ({ rootClassName, }) => {
    ...
    const onEditProfileFormSubmit = React.useCallback((formValues) => _tslib.__awaiter(void 0, void 0, void 0, function* () {
        const { isEmailVerificationRequired, isSmsVerificationRequired } = yield updateUser(Object.assign(Object.assign({}, formValues), { metadata: Object.assign(Object.assign({}, user === null || user === void 0 ? void 0 : user.metadata), formValues.metadata) })); // leave existing custom fields that arent edited untouched
        goToProfileView();
    ...
    return (jsxRuntime.jsxs("div", { className: 'dynamic-widget-edit-profile-container', children: [!multiWallet && isKYCEnabled && (jsxRuntime.jsx(Typography.Typography, { weight: 'regular', color: 'secondary', variant: 'body_normal', className: 'dynamic-widget-edit-profile-view__profile-title', children: "My information" })), jsxRuntime.jsx(UserProfileForm.UserProfileForm, { formClassName: rootClassName, onEditProfileSubmit: onEditProfileFormSubmit, onEditProfileCancel: goToProfileView })] }));
};
