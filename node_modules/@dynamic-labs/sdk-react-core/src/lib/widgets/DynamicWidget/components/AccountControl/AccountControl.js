...
const AccountControl = ({ className }) => {
    ...
    return (jsxs("button", { "data-testid": 'AccountControl', onClick: () => setIsOpen(!isOpen), className: classNames('account-control__container', {
        ...
        }, className), children: [jsx(UserAvatar, { user: user, renderWithFallback: false, containerClassName: 'account-control__social_icon' }), jsx(AuthProviderIcon, { iconSize: 16 }), jsx(Typography, { className: 'account-control__name', as: 'p', children: renderUserIdentifier() }), jsx(Icon, { className: 'account-control__icon', color: 'text-primary', children: jsx(SvgThreeDots, {}) })] }));
};
