...
const PromptModal = ({ children, isShown = true, onClose, }) => {
    ...
    return (jsxRuntime.jsx(Portal.Portal, { handleClose: (e) => onClose === null || onClose === void 0 ? void 0 : onClose(e), isShown: isShown, zIndex: index.authModalZIndex, withBackdrop: true, elementId: elementId, children: jsxRuntime.jsx(Modal.Modal, { children: jsxRuntime.jsxs(ModalCard.ModalCard, { children: [onClose && (jsxRuntime.jsx("div", { className: 'prompt-modal__header', children: jsxRuntime.jsx(IconButton.IconButton, { className: 'prompt-modal__close-button', onClick: (e) => onClose(e), type: 'button', "data-testid": 'close-button', children: jsxRuntime.jsx(close.ReactComponent, {}) }) })), jsxRuntime.jsx("div", { className: 'prompt-modal', children: children })] }) }) }));
};
