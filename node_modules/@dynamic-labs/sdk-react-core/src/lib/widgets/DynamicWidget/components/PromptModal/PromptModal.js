...
const PromptModal = ({ children, isShown = true, onClose, }) => {
    ...
    return (jsx(Portal, { handleClose: (e) => onClose === null || onClose === void 0 ? void 0 : onClose(e), isShown: isShown, zIndex: authModalZIndex, withBackdrop: true, elementId: elementId, children: jsx(Modal, { children: jsxs(ModalCard, { children: [onClose && (jsx("div", { className: 'prompt-modal__header', children: jsx(IconButton, { className: 'prompt-modal__close-button', onClick: (e) => onClose(e), type: 'button', "data-testid": 'close-button', children: jsx(SvgClose, {}) }) })), jsx("div", { className: 'prompt-modal', children: children })] }) }) }));
};
