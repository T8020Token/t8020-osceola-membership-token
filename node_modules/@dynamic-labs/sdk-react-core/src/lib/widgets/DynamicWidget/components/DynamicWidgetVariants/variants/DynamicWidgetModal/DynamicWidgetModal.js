...
const DynamicWidgetModal = ({ children, isShown, onClose, zIndex, className, transitionEvents = {}, }) => {
    ...
    return (jsx(Portal, Object.assign({ zIndex: zIndex, handleClose: () => onClose === null || onClose === void 0 ? void 0 : onClose(), isShown: isShown, withBackdrop: true }, transitionEvents, { children: jsx("div", { className: classNames('dynamic-widget-modal', className), "data-testid": 'modal-card', children: jsx(PopperProvider, { children: children }) }) })));
};
