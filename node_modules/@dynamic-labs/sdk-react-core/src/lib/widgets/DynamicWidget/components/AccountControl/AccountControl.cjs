...
const AccountControl = ({ className }) => {
    ...
    return (jsxRuntime.jsxs("button", { "data-testid": 'AccountControl', onClick: () => setIsOpen(!isOpen), className: classNames.classNames('account-control__container', {
        ...
        }, className), children: [jsxRuntime.jsx(UserAvatar.UserAvatar, { user: user, renderWithFallback: false, containerClassName: 'account-control__social_icon' }), jsxRuntime.jsx(AuthProviderIcon.AuthProviderIcon, { iconSize: 16 }), jsxRuntime.jsx(Typography.Typography, { className: 'account-control__name', as: 'p', children: renderUserIdentifier() }), jsxRuntime.jsx(Icon.Icon, { className: 'account-control__icon', color: 'text-primary', children: jsxRuntime.jsx(threeDots.ReactComponent, {}) })] }));
};
