...
const DynamicAuthLayout = ({ children, className, style, onClose, projectSettings, hideBridgeProgressSteppers, }) => {
    ...
    const { headerData, helpHeaderData, descriptionData } = useDynamicLayoutData.useDynamicLayoutData({
        view: view.type,
    });
    const { showConnectedWalletProgress, showHeader, showHelpContent, showToSFooter, showDynamicFooter, } = useAuthLayoutChecks.useAuthLayoutChecks();
    return (jsxRuntime.jsx(OverlayCardTarget.OverlayCardTarget, { children: jsxRuntime.jsxs(VerticalAccordion.VerticalAccordion, { style: style, className: className, view: view.type, children: [jsxRuntime.jsxs(AccordionItem.AccordionItem, { isOpen: !isFooterExpanded, dimOnHide: true, children: [showConnectedWalletProgress && !hideBridgeProgressSteppers && (jsxRuntime.jsx(WalletProgressStepper.WalletProgressStepper, {})), showHeader && (jsxRuntime.jsx(header.Header, { onClose: onClose, heading: (headerData === null || headerData === void 0 ? void 0 : headerData.heading) || '', projectSettings: projectSettings, copykey: headerData === null || headerData === void 0 ? void 0 : headerData.copykey, description: descriptionData === null || descriptionData === void 0 ? void 0 : descriptionData.text, descriptionCopykey: descriptionData === null || descriptionData === void 0 ? void 0 : descriptionData.copykey })), children, showToSFooter && jsxRuntime.jsx(ToSFooter.ToSFooter, {}), showDynamicFooter && jsxRuntime.jsx(DynamicFooter.DynamicFooter, {})] }), helpHeaderData && showHelpContent && (jsxRuntime.jsx(AccordionItem.AccordionItem, { isOpen: isFooterExpanded, children: jsxRuntime.jsx("div", { children: jsxRuntime.jsx(HelpContent.HelpContent, {}) }, isFooterExpanded.toString()) }))] }) }));
};
