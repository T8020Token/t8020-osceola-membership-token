...
import { useSubdomainCheck } from '../../utils/hooks/useSubdomainCheck/useSubdomainCheck.js';
...
import { useDebounce } from '../../utils/hooks/useDebounce/useDebounce.js';
...
const SubdomainField = ({ showDetails = false, }) => {
    ...
    const runCheckSubdomain = useCallback((value) => __awaiter(void 0, void 0, void 0, function* () {
        if (value !== '' &&
    ...
    const debouncedCheckSubdomain = useDebounce(runCheckSubdomain, 500);
