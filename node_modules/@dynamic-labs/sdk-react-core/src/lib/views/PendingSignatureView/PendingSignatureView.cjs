...
var isHardwareWalletEnabled = require('../../utils/functions/isHardwareWalletEnabled/isHardwareWalletEnabled.cjs');
...
const PendingSignatureView = () => {
     ...
     */
    const isHardwareWallet = isHardwareWalletEnabled.isHardwareWalletEnabled(walletConnector);
    if (!walletConnector) {
        return null;
    }
    ...
    const typographyBodyCopy = isHardwareWallet
        ? t('dyn_pending_signature.phantom_ledger_sign')
        : t('dyn_pending_signature.regular_sign_description');
    return (jsxRuntime.jsxs("div", { className: 'pending-signature__container', "data-testid": 'pending-signature-view', children: [jsxRuntime.jsx(IconWithSpinner.IconWithSpinner, { Icon: icon, iconSize: iconSize, isSpinning: true, indicator: 'connected', className: 'pending-signature__icon-with-spinner' }), jsxRuntime.jsx(Typography.Typography, { variant: 'body_normal', weight: 'regular', className: classNames.classNames('pending-signature__copy'), copykey: isHardwareWallet
                    ? 'dyn_pending_signature.phantom_ledger_sign'
                    : 'dyn_pending_signature.regular_sign_description', children: typographyBodyCopy }), isHardwareWallet && (jsxRuntime.jsxs(Typography.Typography, { variant: 'body_small', weight: 'regular', className: classNames.classNames('pending-signature__copy', 'pending-signature__copy--mini'), copykey: 'dyn_pending_signature.phantom_ledger_warning', children: [jsxRuntime.jsx("strong", { children: t('dyn_pending_signature.note') }), t('dyn_pending_signature.phantom_ledger_warning')] })), requiresTwoStepAuthentication.requiresTwoStepAuthentication(walletConnector) && (jsxRuntime.jsx(TypographyButton.TypographyButton, { buttonClassName: 'pending-signature__button', onClick: handleClick, loading: loading, buttonVariant: 'primary', buttonPadding: 'large', expanded: true, typographyProps: {
