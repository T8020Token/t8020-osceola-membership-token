...
const DefaultTile = ({ leading, name, onClick, trailing, }) => (jsx(ListTile, { leading: leading, trailing: trailing, onClick: onClick, className: 'onramp-item__tile', dataTestId: 'ListTile', children: name }));
const OnRampItem = ({ disabled = false, onramp, onResetSearchValue, tile = DefaultTile, onSelectOnRamp, trailingProp = undefined, }) => {
    ...
    const leading = (jsx(Icon, { className: 'onramp-item__icon', children: jsx("img", { src: onramp.iconUrl, alt: onramp.displayName }) }));
    const trailing = trailingProp !== null && trailingProp !== void 0 ? trailingProp : (jsx(ListTileAnimatedTrailing, { hoverElement: 
        // eslint-disable-next-line react/jsx-wrap-multilines
        jsx(Icon, { color: 'text-tertiary', size: 'mini', children: jsx(SvgStroke, {}) }) }));
