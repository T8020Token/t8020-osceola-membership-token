...
const DefaultTile = ({ leading, name, onClick, trailing, }) => (jsxRuntime.jsx(ListTile.ListTile, { leading: leading, trailing: trailing, onClick: onClick, className: 'onramp-item__tile', dataTestId: 'ListTile', children: name }));
const OnRampItem = ({ disabled = false, onramp, onResetSearchValue, tile = DefaultTile, onSelectOnRamp, trailingProp = undefined, }) => {
    const Tile = tile;
    ...
    const name = onramp.displayName;
    const leading = (jsxRuntime.jsx(Icon.Icon, { className: 'onramp-item__icon', children: jsxRuntime.jsx("img", { src: onramp.iconUrl, alt: onramp.displayName }) }));
    const trailing = trailingProp !== null && trailingProp !== void 0 ? trailingProp : (jsxRuntime.jsx(ListTileAnimatedTrailing.ListTileAnimatedTrailing, { hoverElement: 
        ...
        jsxRuntime.jsx(Icon.Icon, { color: 'text-tertiary', size: 'mini', children: jsxRuntime.jsx(stroke.ReactComponent, {}) }) }));
