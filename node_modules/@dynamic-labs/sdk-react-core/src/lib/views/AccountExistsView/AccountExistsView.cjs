...
const AccountExistsView = () => {
    ...
    const renderFullMessage = () => {
        const messageTrail = embeddedSocialSigninProvider ? (t('dyn_account_exists.description_social')) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [t('dyn_account_exists.description_email'), " ", jsxRuntime.jsx("strong", { children: email }), ' ', t('dyn_account_exists.trail_message_email')] }));
        return messageTrail;
    };
