...
const FarcasterConnectView = ({ url }) => {
    ...
    const icon = jsxRuntime.jsx(iconic.SocialIcon, { name: 'farcaster', variant: iconThemeVariant });
    return (jsxRuntime.jsx(QrCodeWrapper.QrCodeWrapper, { uri: url, accentColor: iconThemeVariant === 'dark' ? theme.colors.textPrimary : '#7b65c0', icon: icon, showCopyToClipboardButton: true }));
};

exports.FarcasterConnectView = FarcasterConnectView;
