...
var PasskeySignInSection = require('../sections/PasskeySignInSection/PasskeySignInSection.cjs');
...
const LoginViewSection = ({ viewSection, index, walletCount, gotToWalletList, }) => {
    ...
    switch (viewSection.type) {
        ...
        case sdkApiCore.SdkViewSectionType.Wallet:
            return (jsxRuntime.jsx(WalletSignInSection.WalletSignInSection, { numberOfItemsToShow: viewSection.numOfItemsToDisplay || 0, onSubmit: gotToWalletList, isLoading: isLoading }));
        ...
        case sdkApiCore.SdkViewSectionType.Passkey:
            return (jsxRuntime.jsx(PasskeySignInSection.PasskeySignInSection, { onSubmit: () => setIsLoading(true), onSubmitError: () => setIsLoading(false), isLoading: isLoading }));
