...
var accessBlocked = require('../../shared/assets/access-blocked.cjs');
...
var IpConfigurationContext = require('../../context/IpConfigurationContext/IpConfigurationContext.cjs');
...
const AccessBlockedView = () => {
    ...
    const { getIpConfiguration } = IpConfigurationContext.useIpConfigurationContext();
    usePromise.usePromise(getIpConfiguration, {
