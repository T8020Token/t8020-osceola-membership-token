...
const PasskeyInitRecovery = ({ authenticatorType, }) => {
    ...
    const { initAuthMethod, isLoading, error } = useInitEmbeddedWalletAuthMethod.useInitEmbeddedWalletAuthMethod();
    ...
    const closeButton = (jsxRuntime.jsx(IconButton.IconButton, { type: 'button', onClick: () => setShowAuthFlow(false, { emitCancelAuth: true }), "data-testid": 'close-button', children: jsxRuntime.jsx(close.ReactComponent, {}) }));
