...
const AuthChoiceInfo = ({ choice, variant = 'default', }) => {
    ...
    return (jsxRuntime.jsx("div", { className: 'auth-choice-info', children: authChoiceInfoMap[choice][variant].map((info, index) => (jsxRuntime.jsxs("div", { className: 'auth-choice-info__container-item', children: [jsxRuntime.jsx("div", { className: 'auth-choice-info__container-icon', children: jsxRuntime.jsx(Icon.Icon, { size: 'medium', className: 'auth-choice-info__icon', children: jsxRuntime.jsx(add.ReactComponent, {}) }) }), jsxRuntime.jsxs("div", { className: 'action-card__item-title', children: [jsxRuntime.jsx(Typography.Typography, { variant: 'body_normal', weight: 'regular', copykey: info.title, children: t(info.title) }), jsxRuntime.jsx(Typography.Typography, { variant: 'body_small', weight: 'regular', color: 'secondary', copykey: info.description, children: t(info.description) })] })] }, `authChoiceInfo_${index}`))) }));
};

exports.AuthChoiceInfo = AuthChoiceInfo;
