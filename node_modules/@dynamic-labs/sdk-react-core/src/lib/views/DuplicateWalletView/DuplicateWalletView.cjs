...
const DuplicateWalletView = ({ onReturn, initiatedByWidget, }) => {
    ...
    return (jsxRuntime.jsx("div", { "data-testid": 'duplicate-wallet-view', children: jsxRuntime.jsxs("div", { className: 'duplicate-wallet-view__content', children: [jsxRuntime.jsx(IconWithSpinner.IconWithSpinner, { Icon: icon, customSpinnerColor: 'red', iconSize: iconSize, className: 'duplicate-wallet-view__icon', isSpinning: true }), jsxRuntime.jsx(Typography.Typography, { variant: 'body_normal', color: 'secondary', weight: 'regular', copykey: 'dyn_duplicate_wallet.description', children: t('dyn_duplicate_wallet.description') }), jsxRuntime.jsx(TypographyButton.TypographyButton, { onClick: () => onReturn(initiatedByWidget), buttonClassName: 'duplicate-wallet-view__button', buttonVariant: 'brand-primary', buttonPadding: 'large', copykey: 'dyn_duplicate_wallet.return', typographyProps: {
                        color: 'white',
                        weight: 'regular',
                    }, children: t('dyn_duplicate_wallet.return') })] }) }));
};

exports.DuplicateWalletView = DuplicateWalletView;
