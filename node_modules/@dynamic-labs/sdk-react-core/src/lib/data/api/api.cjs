...
const sdkApi = ({ customHeaders } = {}) => {
    const settings = {
        ...
        headers: Object.assign(Object.assign({ 'Content-Type': 'application/json', 'x-dyn-request-id': randomString.randomString(50) }, getApiHeaders.getApiHeaders()), customHeaders),
    };
