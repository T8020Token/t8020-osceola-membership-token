...
const NonNetworkSwitchingSupportedControl = ({ walletConnector, className, showNetworkName = false, network, enabledNetworks, }) => {
    ...
    const currentNetwork = useMemo(() => {
        ...
        return networkName ? capitalize(networkName) : undefined;
    ...
    const shouldShowUnsupportedNetwork = useMemo(() => !currentNetwork && enabledNetworks && enabledNetworks.length > 0, [currentNetwork, enabledNetworks]);
    if (isLoading) {
        return jsx(NetworkControlSkeleton, { className: className });
    }
    return (jsxs("div", { "data-testid": 'NonNetworkSwitchingSupportedControl', className: classNames('non-network-switching-supported-control', className), children: [shouldShowUnsupportedNetwork && (jsx(UnsupportedNetwork, { showMsg: showNetworkName })), !shouldShowUnsupportedNetwork && (jsxs(Fragment, { children: [jsx(Icon, { size: 'small', children: (chain === null || chain === void 0 ? void 0 : chain.icon) ? (jsx("img", { src: chain.icon, alt: `${chain.name} icon` })) : (jsx(ChainIcon, {})) }), showNetworkName && (jsx(Typography, { className: classNames('non-network-switching-supported-control__network-name'), as: 'span', variant: 'body_small', children: currentNetwork !== null && currentNetwork !== void 0 ? currentNetwork : chainName }))] }))] }));
};
